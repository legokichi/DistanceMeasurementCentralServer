...
(function() {
  var HEIGHT, RULED_LINE_INTERVAL, TIME_DATA, WIDTH, drgTrgPtr, main, socket;
  ...
  socket.on("colors", function(datas) {
    return console.log("colors", JSON.stringify(datas.map(function(arg) {
      var color, id;
  ...
  socket.on("repos", function(_TIME_DATA) {
    var aliases, currentTimes, delayTimes, distances, now, pulseTimes, recStartTimes;
