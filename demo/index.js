...
(function() {
  var abufA, abufB, actx, anodeA, anodeB, goldA, goldB, input_processor, left, n, osc, recbuf, right, signalA, signalB, socket;
  ...
  setTimeout(function() {
    ...
    return view(Signal.fft_smart_overwrap_correlation(signalB, signalB), 1024);
  });
  ...
  input_processor.addEventListener("audioprocess", function(ev) {
    var _signalA, _signalB, buffer, rawdata;
    ...
    if (actx.currentTime > 10) {
      ...
      return view(Signal.fft_smart_overwrap_correlation(rawdata, _signalB), 1024);
    }
  });
  ...
  right = function(stream) {
    ...
    return source.connect(input_processor);
  };
