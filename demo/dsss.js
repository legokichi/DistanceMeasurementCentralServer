...
(function() {
  var DSSS_SPEC, MULTIPASS_DISTANCE, SOUND_OF_SPEED, VIEW_SIZE, _craetePictureFrame, _lowpass, _prepareRec, _prepareSpect, actx, analyser, beepPulse, changeColor, collect, isBroadcasting, isRecording, main, osc, processor, pulseStartTime, pulseStopTime, ready, recbuf, sendRec, socket, startPulse, startRec, stopPulse, stopRec;
    ...
    return function(next) {
      ...
      results = datas.map(function(arg) {
        ...
        _results = startStops.map(function(arg1) {
          var S, T, _, _S, _frame, _id, coms, correl, correls, down_correls, idxS, j, k, low_correls, marker, marker2, matched, max_offset, mse_correls, pulseTime, range, ref, results1, results2, section, startPtr, stopPtr;
          ...
          mse_correls = correls.map(function(a) {
            return a.map(function(a) {
              return a * a;
            });
          });
          low_correls = mse_correls.map(function(a) {
            return _lowpass(a, actx.sampleRate, 1000, 1);
          });
          down_correls = low_correls.map(function(a) {
            var i, val;
          ...
          S.forEach(function(_, i) {
            return S[i] = down_correls.reduce((function(a, v) {
              return a + v[i];
            }), 0);
          });
          ...
          marker2[idxS + range] = 255;
          coms = [[section, true, true], [correl, true, true], [marker, true, true], [S, true, true], [_S, true, true]].forEach(function(com, i) {
            var render;
