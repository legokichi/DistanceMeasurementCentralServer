...
var DSSS_SPEC, VIEW_SIZE, _craetePictureFrame, _lowpass, _prepareRec, _prepareSpect, actx, analyser, beepPulse, changeColor, collect, isBroadcasting, isRecording, main, osc, processor, pulseStartTime, pulseStopTime, ready, recbuf, sendRec, socket, startPulse, startRec, stopPulse, stopRec;
...
collect = function(datas) {
  return function(next) {
    var aliases, delayTimes, distances, distancesAliased, pulseTimes, relDelayTimes, results, sampleRates;
