...
(function() {
  var Detector, POST_URL, RecordBuffer, Wave, post,
  ...
  this._Hoge = (function() {
    ...
    _Hoge.prototype.collectRec = function(data) {
      return (function(_this) {
        return function(next) {
          var experimentID, int16arr, json, sampleRate, startStops, timeStamp, wave;
          experimentID = data.experimentID, timeStamp = data.timeStamp;
          startStops = _this.getStartStops();
          ...
          return Promise.all([
            post(POST_URL, {
              filename: experimentID + "_" + timeStamp + "_" + _this.color + "_" + socket.id + ".wav",
              file: wave
            }), post(POST_URL, {
              filename: experimentID + "_" + timeStamp + "_" + _this.color + "_" + socket.id + ".json",
              file: json
            })
    ...
    _Hoge.prototype.collect = function(next) {
      var f32arr, results, startStops;
      startStops = this.getStartStops();
