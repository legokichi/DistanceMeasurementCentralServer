...
(function() {
  ...
  this._Hoge = (function() {
    ...
    _Hoge.prototype.collect = function(data) {
      return (function(_this) {
        return function(next) {
          var color, dat, experimentID, f32arr, id, int16arr, json, results, sampleRate, startStops, timeStamp, wave;
          ...
          dat = new Blob([f32arr]);
          results = _this.detector.calc(f32arr, startStops);
          _this.recbuf.clear();
          return Promise.resolve().then(function() {
            ...
            return post(POST_URL, {
              filename: experimentID + "_" + timeStamp + "_" + color + "_" + id + ".dat",
              file: dat
            });
          }).then(function() {
            return post(POST_URL, {
            ...
            foldable = results.map(function(arg) {
              ...
              return function() {
                ...
                foldable2 = Object.keys(images).map(function(filename) {
                  return function() {
                    return post(POST_URL, {
                      filename: experimentID + "_" + timeStamp + "_" + color + "_" + id + "_" + filename,
      ...
      return (function(_this) {
        return function(next) {
          data.forEach(function(arg) {
            ...
            console.group(id);
            console.log(id);
            console.table(results.map(function(a) {
              return a.results;
            }));
